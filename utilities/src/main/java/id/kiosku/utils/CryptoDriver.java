...
import id.kiosku.utils.contracts.CryptoData;
import id.kiosku.utils.exceptions.InvalidMacCryptoException;

public class CryptoDriver {
    private String key;
    private byte[] keyBytes;
    public CryptoDriver(){
        this(KUtility.MD5(KUtility.randomNumber(32)));
    }

    public CryptoDriver(String key){
        this.key = KUtility.MD5(key);
        try {
    ...
    public CryptoData encrypt(String message){
        return encrypt(message, KUtility.random(16));
    }
    ...
    public static class HMAC {
        ...
        public static String generate(String algo, String msg, String keyString) {
            ...
            try {
                ...
                digest = KUtility.bytesToHex(bytes);
            } catch (Exception e) {
